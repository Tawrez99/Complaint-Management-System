<%-- 
    ...
    Created on : 30 Aug, 2014, 11:08:04 AM
    Author     : Hrishikesh
--%>
...
<td width="100%" height="19" colspan="10" align="left"><font  size="1" >3. Loss of card may please be reported immediately to the issuing authority.</font></td>
 ...
 required by the contractor. </font></td>
  ...
  <tr><td colspan="10" align="center"><a href="\GatepassVisitor\PrintForeignerGatePassPopUp.jsp?srNo=<%=rs.getInt(1) %>" onClick="printPagePopUp(this)">Print
