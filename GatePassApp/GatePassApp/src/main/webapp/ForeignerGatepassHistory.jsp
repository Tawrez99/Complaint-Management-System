...
<div class="container">
  ...
  <form action="/GatepassVisitor/saveForeignerGatePasDetails" method="post" 
    ...
    <div class="table-container">
      <table id="registerTable">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <a href="/GatepassVisitor/PrintForeignerGatePassPopUp.jsp?srNo=<%=rs1.getInt(1)%>"
    ...
    <div class="btn-bar">
      <button type="button" class="btn" onclick="window.location.href='/GatepassVisitor/ForeignerGatepassEntry.jsp'">
         New Entry
      </button>
