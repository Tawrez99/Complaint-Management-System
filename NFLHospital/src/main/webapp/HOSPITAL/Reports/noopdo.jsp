...
<body>
<p align="center"><b><font size="4">Today's OPD Detail For Others</font><font size="5"> </font></b>
<% 
...
DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());	
	...
	ResultSet rs = stmt.executeQuery("select * FROM PRODUCTION.opdo where opddate > sysdate-1");
while(rs.next())
	{
...
<%
ResultSet rs1 = stmt.executeQuery("select count(*) nopd from production.opdo where opddate > sysdate-1");
while(rs1.next())
	{
