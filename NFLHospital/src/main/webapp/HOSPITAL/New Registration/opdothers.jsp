...
DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());	
	...
	ResultSet rs = stmt.executeQuery("insert into production.opd(SRNO, PATIENTNAME, EMPNAME, RELATION, AGE, OPDDATE, SEX, EMPN) values(patient_seq.NEXTVAL,'"+pname+"','"+ename+"','"+rel+"','"+age+"',sysdate,'"+sex+"','"+empn+"')");
	while(rs.next())
	{
	//d = rs2.getString("sysd");
	}
	ResultSet rs4 = stmt.executeQuery("select to_char(sysdate,'dd-mon-yyyy') d from dual");
	while(rs4.next())
	{
	d = rs4.getString("d");
	}
...
<div align="center">
  <center>
  <table border="0" width="46%" height="1" style="border-style: solid; border-width: 1">
    <tr>
  ...
  <center>
     ...
     <tr>
  	 ...
  	 <td width="40%" height="1"><font size="1" face="Arial"><%=empn%></font></td>
  	 <td width="19%" height="1"><b><font face="Arial" size="1">E.Name</font></b></td>
  	 <td width="35%" height="1"><font size="1" face="Arial"><%=ename%></font></td>
    </tr>
     <tr>
  	 ...
  	 <td width="35%" height="1"><font size="1" face="Arial"><%=age%></font></td>
   </tr>
     <tr>
