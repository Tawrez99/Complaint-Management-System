...
<% 
	...
	String rel = request.getParameter("D1");
    ...
    try 
        {
           ...
           ResultSet rs = stmt.executeQuery("insert into dependents(DNAME, RELATION, EMPN,SEX, BIRTHYEAR) values('"+dname+"','"+rel+"','"+empn+"','"+sex+"','"+dob+"')");
...
%>
<P align="center"><font color="#000080">One Record Saved !!</font></P>
