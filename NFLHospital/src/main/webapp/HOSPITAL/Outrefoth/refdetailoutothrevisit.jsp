  ...
  <table border="0" width="59%" height="491" style="border-style: solid; border-width: 1">
    ...
    <tr>
      <td width="100%" height="510">
        ...
        <p><font face="Kruti Dev 010">&nbsp;&nbsp;vkjafHkd dze la0</font><font face="Arial" size="2">:&nbsp;<%= refno%></font>&nbsp;&nbsp;&nbsp;&nbsp;
        <font face="Kruti Dev 010">fnukad</font><font face="Arial" size="2">: <%=refdt%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font>
        <font face="Kruti Dev 010">jh&amp;foftV fnukad %</font><%=refdt1%> </p>
        ...
        <p><font face="Arial">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">&nbsp; Chief Medical Officer / Medical Officer</font></p>
        </font>
