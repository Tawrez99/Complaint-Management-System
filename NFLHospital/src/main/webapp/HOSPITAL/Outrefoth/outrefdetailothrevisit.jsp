...
<body background="../Stationery/Glacier%20Bkgrd.jpg">
 <form name="MyForm" method="POST" action="/hosp1/HOSPITAL/Outrefoth/refdetailoutothrevisit.jsp" onsubmit="validate();" >
 <%
    ...
    try 
        {
           ...
           ResultSet rs = stmt.executeQuery("select a.patientname,a.empn,a.sex,a.rel,a.age,b.code,b.doctor_name,c.HCODE,c.HNAME, format(a.refdate,'dd-mmm-yyyy'),format(Now(),'dd-mm-yyyy'),a.disease from OUTREFDETAIL"+yr+" A, DOCTOR B, OUTSTATIONHOSPITAL C WHERE a.DOC=b.CODE and a.HOSPITAL=c.HCODE and a.refno = "+refno);
             if (rs.next())
                {
