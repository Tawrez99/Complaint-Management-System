...
<body>
<% 
    String emp =request.getParameter("userid");    
  ...
  try 
     {
	     ...
	     ResultSet rs = stmt.executeQuery("select A.USERNAME, A.PASSWD from PERSONNEL.USRPASS A where a.username='"+emp+"' and a.passwd='"+pwd+"'");
	      ...
	      if(flag==true)
	         {
	            String link=new String("reportoption.jsp?q="+emp+"");
