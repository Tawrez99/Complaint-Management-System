...
<body background="../Stationery/Glacier%20Bkgrd.jpg">
 ...
 <form name="MyForm" method="POST" action="/hosp1/HOSPITAL/Outref/dep/refdetailoutdeprevisit.jsp" onsubmit="validate();" >
 <%
    ...
    try 
    	...
    	conn = DBConnect.getConnection();
           ...
           ResultSet rs = stmt.executeQuery("select a.patientname,a.empn,a.sex,a.rel,a.age,a.doc,c.HCODE,c.HNAME, to_char(a.refdate,'dd-mm-yyyy'),to_char(sysdate,'dd-mm-yyyy'),a.disease from OUTREFDETAIL"+yr+" A,  OUTSTATIONHOSPITAL C WHERE a.HOSPITAL=c.HCODE and a.refno = "+refno+"");
             if (rs.next())
                {
...
%>
  ...
  revisit For out Reference</u></span></b></font></p>
  <p align="center">&nbsp;</p>
<div align="center">
  <center>
  <table border="0" width="44%" style="border-style: solid; border-width: 1">
    ...
    <tr>
      <td width="50%"><font face="Tahoma" size="2"><b>Referred to Hospital&nbsp; </b></font></td>
       <td width="50%"><font face="Tahoma" size="2" color="#0000FF"><b><input type="text" name="referto" readonly  value="<%= hname%>" size="21"></b></font></td>
    </tr>
    <tr>
      <td width="50%"><b><font face="Tahoma" size="2">Escort</font></b></td>
    ...
    <tr>
      <td width="50%"><font face="Tahoma" size="2"><b>Referred By </b></font></td>
      <td width="50%"><font face="Tahoma" size="2" color="#0000FF"><b><input type="text" name="referby" value="<%=dname%>" size="21"></b></font></td>
    </tr>
