...
<%@ include file="/navbar.jsp" %>
 ...
 Reference HISTORY</u></span></b></font></p>
  <div align="center">
    <center>
  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="80%">
    <tr>
      ...
      <td width="10%"><font face="Arial Narrow"><b>Ref. Date</b></font></td>
      <td width="10%"><font face="Arial Narrow"><b>Empn</b></font></td>
      <td width="17%"><font face="Arial Narrow"><b>Patient Name</b></font></td>
      <td width="8%"><font face="Arial Narrow"><b>Relation</b></font></td>
      <td width="15%"><font face="Arial Narrow"><b>Referred To</b></font></td>
      <td width="15%"><font face="Arial Narrow"><b>Referred By</b></font></td>
      <td width="15%"><b><font face="Arial Narrow">Refer Type</font></b></td>
    </tr>
 <%
...
%>
    ...
    <tr>
      <td width="5%"><%=refno%>&nbsp;</td>
      <td width="10%"><%=refdt%>&nbsp;</td>
      <td width="10%"><%=empn %>&nbsp;</td>
      <td width="17%"><%=name%>&nbsp;</td>
      <td width="8%"><%=relation%>&nbsp;</td>
      <td width="15%"><%=refto%>&nbsp;</td>
      <td width="15%"><%=refby%>&nbsp;</td>
      <td width="15%"><%=reftype%>&nbsp;</td>
    </tr>
 <%
