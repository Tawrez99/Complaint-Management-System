 ...
 <%
    ...
    try 
    	...
    	conn = DBConnect.getConnection();
           ...
           ResultSet rs = stmt.executeQuery("select a.patientname,a.empn,a.sex,a.rel,a.age,a.doc,c.HCODE,c.HNAME, to_char(a.refdate,'dd-mm-yyyy'),to_char(sysdate,'dd-mm-yyyy'),a.disease from LOACALREFDETAIL"+yr+" A, LOCALHOSPITAL C WHERE a.SPECIALIST=c.HCODE and a.refno = "+refno+"");
             if (rs.next())
                {
