...
DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());	
	...
	ResultSet rs = stmt.executeQuery("select initcap(name) NAME,desg,(to_char(sysdate,'yyyy')-to_char(BIRTHDATE,'yyyy'))age,sex FROM PRODUCTION.w_personal where to_char(empn)="+en1);
while(rs.next())
	{
